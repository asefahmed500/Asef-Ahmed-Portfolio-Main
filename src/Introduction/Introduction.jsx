...
const Introduction = () => {
    ...
    const handleDownload = () => {
        ...
        link.href = asefcv;
        link.download = 'Asef_Ahmed_Resume.pdf'; // File name for the download
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 p-4 sm:p-6 lg:p-10 items-center">
            ...
            <div className="space-y-6 lg:space-y-10 mt-10 lg:mt-20 text-center lg:text-left">
                ...
                <button
                    ...
                    className="btn btn-primary inline-flex items-center space-x-2 text-sm sm:text-base lg:text-lg"
                >
                    <AiOutlineDownload />
